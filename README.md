# ДЗ Работа с проектом и приложением
...
- Написаны функции для показа времени и рабочей директории.
- Созданы HTML-шаблоны для страниц на которых указывается время и текущая директория, для реализации возможности навигации между страницами.
- Написан и закомментирован скрипт для подключения к PostgreSQL, вместо SQLite.
